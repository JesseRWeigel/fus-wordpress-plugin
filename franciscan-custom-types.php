 ...
 // 		'public' => true,
  ...
  //   'show_in_menu'       => true,
    ...
    'graphql_plural_name' => 'studentProfilePages',
						...
						// Create Missions Page type
	// set up labels
	$labels = array(
		'name' => 'Missions Pages',
			'singular_name' => 'Missions Page',
			'add_new' => 'Add New Missions Page',
			'add_new_item' => 'Add New Missions Page',
			'edit_item' => 'Edit Missions Page',
			'new_item' => 'New Missions Page',
			'all_items' => 'All Missions Pages',
			'view_item' => 'View Missions Page',
			'search_items' => 'Search Missions Pages',
			'not_found' =>  'No Missions Pages Found',
			'not_found_in_trash' => 'No Missions Pages found in Trash',
			'parent_item_colon' => '',
			'menu_name' => 'Missions Pages',
		);
		//register post type
	register_post_type( 'missions-page', array(
		'labels' => $labels,
		'has_archive' => true,
		'public' => true,
		'supports' => array( 'title', 'editor', 'excerpt', 'thumbnail'),
		'exclude_from_search' => false,
		'capability_type' => 'post',
		'rewrite' => array( 'slug' => 'missions-pages' ),
		'show_in_rest'       => true,
    'show_in_menu'       => true,
    'show_in_graphql' => true,
    'graphql_single_name' => 'missionsPage',
    'graphql_plural_name' => 'missionsPages',
		)
	);

							// Create CTA Page type
	// set up labels
	$labels = array(
		'name' => 'CTAs',
			'singular_name' => 'CTA',
    ...
    'show_in_menu'       => true,
    'show_in_graphql' => true,
    'graphql_single_name' => 'cta',
    'graphql_plural_name' => 'ctas',
		)
	);

								// Create Job Page type
	// set up labels
	$labels = array(
		'name' => 'Jobs',
			'singular_name' => 'Job',
    ...
    'graphql_plural_name' => 'jobs',
									...
									// Create Alumni Outcome Page type
	// set up labels
	$labels = array(
		'name' => 'Alumni Outcomes',
			'singular_name' => 'Alumni Outcome',
			'add_new' => 'Add New Alumni Outcome',
			'add_new_item' => 'Add New Alumni Outcome',
			'edit_item' => 'Edit Alumni Outcome',
			'new_item' => 'New Alumni Outcome',
			'all_items' => 'All Alumni Outcomes',
			'view_item' => 'View Alumni Outcome',
			'search_items' => 'Search Alumni Outcomes',
			'not_found' =>  'No Alumni Outcomes Found',
			'not_found_in_trash' => 'No Alumni Outcomes found in Trash',
			'parent_item_colon' => '',
			'menu_name' => 'Alumni Outcomes',
		);
		//register post type
	register_post_type( 'alumni-outcome', array(
		'labels' => $labels,
		'has_archive' => true,
		'public' => true,
		'supports' => array( 'title', 'editor', 'excerpt', 'thumbnail'),
		'exclude_from_search' => false,
		'capability_type' => 'post',
		'rewrite' => array( 'slug' => 'alumni-outcomes' ),
		'show_in_rest'       => true,
    'show_in_menu'       => true,
    'show_in_graphql' => true,
    'graphql_single_name' => 'alumniOutcome',
    'graphql_plural_name' => 'alumniOutcomes',
		)
	);
